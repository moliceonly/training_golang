...
├── pkg/part01/            # 练习包
│   ├── …                  # 起点 / 1.1
│   └── stdlibpractice/    # 1.4 标准库 SDK（题 75–80、82–85）
...
| **1.4** 标准库 SDK | 进行中 | `pkg/part01/stdlibpractice`（75–80、82–85） |
...
| `pkg/part01/stdlibpractice` | **1.4**：文本库、time、JSON、Base64、SHA256、AES-GCM、regexp/slices、flag、slog、context |
